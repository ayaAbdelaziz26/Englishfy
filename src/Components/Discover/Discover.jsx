...
import { Link } from 'react-router-dom'; // Add react-router for page navigation
...
const StyledMenu = styled((props) => (
  ...
  '& .MuiPaper-root': {
    ...
    minWidth: 180,
    backgroundColor: '#415A77',  // Set the Menu background color to #0d1b2a
    color: '#fff',  // Adjust color for contrast
    boxShadow:
...
const StyledLink = styled(Link)({
  ...
  color: '#ECCD48',  // Set link color to yellow
